 ...
 * GET    /countries/:code                 — single country info + format
 * GET    /validate/:country/:regNumber    — validate via URL params
 * POST   /validate                        — validate single { countryCode, regNumber }
 * POST   /validate/batch                  — validate array of { countryCode, regNumber }
 */

import { Router } from "express";
import { validateCompanyReg, batchValidate, getCountries, getCountryInfo } from "./validationService.js";
